...
public class UserListAdapterEntity {

    private Context ma;
    private ArrayList<User> users;
    private ArrayList<User> filteredUserList;

    public UserListAdapterEntity(Context ma, ArrayList<User> users) {
        this.ma = ma;
        this.users = users;
        ...
        if(filteredUserList.size() > 0) {
            ...
            if (userStatus.contains(NetworkUtil.ONLINE_STATUS)) {
                convertView.findViewById(R.id.onlineStatus)
                        .setBackground(ContextCompat.getDrawable(ma, R.drawable.network_status_online));
            } else if (userStatus.contains(NetworkUtil.AFK_STATUS)) {
                convertView.findViewById(R.id.onlineStatus)
                        .setBackground(ContextCompat.getDrawable(ma, R.drawable.network_status_afk));
                ...
                convertView.findViewById(R.id.onlineStatus)
                        .setBackground(ContextCompat.getDrawable(ma, R.drawable.network_status_offline));
            } else {
